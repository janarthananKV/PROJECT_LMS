...
const MyEnrollments = () => {
  ...
  const {enrolledCourses,calculateNoOfLectures, calculateCourseDuration, navigate, userData, fetchUserEnrolledCourses, backendUrl, getToken} = useContext(AppContext)
