                  ...
                  <ul className='list-disc md:pl-10 pl-4 pr-4 py-2 text-gray-600 border-t border-gray-300 '>
                    {chapter.chapterContent.map((lecture, i) => (
                      <li className='flex items-start gap-2 py-1' key={i}>
                        <img className='w-4 h-4 mt-1' src={progressData && progressData.lectureCompleted.includes(lecture.lectureId) ? assets.blue_tick_icon : assets.play_icon} alt="play icon" />
          ...
          {PlayerData ? (
            <div>
              ...
              <div className='flex justify-between items-center mt-5'>
                ...
                <button onClick={() => markLectureAsCompleted(PlayerData.lectureId)} className='text-blue-600 font-semibold'>{progressData && progressData.lectureCompleted.includes(PlayerData.lectureId) ? 'Completed' : 'Mark Complete'}</button>
              </div>
            </div>
